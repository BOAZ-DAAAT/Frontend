...
import styles from './WavePlaygroundEdge.module.css';

// Dormant variant retained for future reactivation; it is not registered in edgeTypes.
...
export function WavePlaygroundEdge({
  id,
  sourceX,
  sourceY,
  sourcePosition,
  ...
  if (isActive) {
    ...
    const whiteWave = createWavePath(start, sourceControl, targetControl, end, waveTime, 3, 3.25);
    ...
    return (
      <>
        ...
        <path className={`${styles.wave} ${styles.waveWhite}`} d={whiteWave} />
